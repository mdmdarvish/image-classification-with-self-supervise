...
class _DenseLayer(nn.Module):
    def __init__(self, in_channels, growth_rate, group_1x1,group_3x3,bottleneck,condense_factor,dropout_rate):
...
class _DenseBlock(nn.Sequential):
    def __init__(self, num_layers, in_channels, growth_rate, 
                 group_1x1,group_3x3,bottleneck,condense_factor,dropout_rate):
...
class CondenseNet(nn.Module):
    def __init__(self, stages,data, growth,num_classes,
                 group_1x1,group_3x3,bottleneck,condense_factor,dropout_rate):
        ...
        self.classifier2 = nn.Linear(self.num_features, 4)
    ...
    def add_block(self, i):
        ...
        block = _DenseBlock(
            ...
            self.num_features,
            self.growth[i],
            self.group_1x1,self.group_3x3,self.bottleneck,self.condense_factor,self.dropout_rate         )
    ...
    def forward(self, x, progress=None):
        ...
        z  = features.view(features.size(0), -1)
        out1 = self.classifier(z)
        out2 = self.classifier2(z)
        out2 = self.soft(out2)
        return out1,out2